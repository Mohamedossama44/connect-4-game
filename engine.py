...
# this heuristc sugested when k =2
...
#         score += 1000  # Strong winning opportunity
#     elif consecutive_pieces == 2 and free_slots == 2:
#         score += 500  # Potential winning connection


#     if opponent_consecutive == 4:
#         score -= 7000  # Win oponent condition
#     # oponent 
...
## this heuristc sugested when k=4 
def evaluate_window(window, piece):
    score = 0
    if piece == 2 :
        opponent_piece=1
